...
def make_rawlist(path, runnumber, PreProcessTrigOverlap):
    ...
    if PreProcessTrigOverlap == True:
        ...
        movePre = "mv ./my_files.txt configfiles/DataDecoder/"
...
def run_beam_fetcher(my_run, path):
    ...
    tool = "./Analyse configfiles/BeamFetcher/ToolChainConfig" 
    print(tool)
    os.system(tool) 
...
def run_PreProcessTrigOverlap(path, runnnumber):
    ...
    tool = "./Analyse configfiles/PreProcessTrigOverlap/ToolChainConfig" 
    print(tool)
    os.system(tool) 

def run_DataDecoderMRD(path, runnnumber):
    make_rawlist(path, runnnumber, False) 
    tool = "./Analyse configfiles/DataDecoderMRD/ToolChainConfig" 
    print(tool)
    os.system(tool) 

def run_DataDecoder(path, runnnumber):
    make_rawlist(path, runnnumber, False) 
    tool = "./Analyse configfiles/DataDecoder/ToolChainConfig" 
    print(tool)
    os.system(tool) 
